...
Bonobo is a work-in-progress userscript manager extension for Chromium browsers.

## License
All of Bonobo's files besides `wordmark.png` and the files in `icons/` are licensed under the GPLv2 license (see `GPLv2.txt`):
~~~
    Copyright (C) 2026 bonobo-devs
